...
# which is accepted by the algorithms. As our dataset contains two features as Wether and Temperature. 
# We have to replace each string field into numeric constants by using LabelEncoder from processing 
# module of sklearn.
...
# Step 4:
# Test Data
# After successful training now we can test our trained data by passing some value of wether and 
# temperature. As we are using KNN algorithm use value of K as 3.
