...
for feature, importance in zip(student_data, feature_importance):
    print(feature, ":", importance)

most_important = student_data[feature_importance.argmax()]
least_important = student_data[feature_importance.argmin()]
