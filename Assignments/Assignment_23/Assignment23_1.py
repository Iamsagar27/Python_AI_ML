...
# Define a constructor (_init that accepts Name and Author and initializes instance variables.
...
# Example usage:
# Objl BookStore ("Linux System Programming", "Robert Love")
# Objl. Display()
...
Obj1 = BookStore("Linux System Programming", "Dennis Ritchie")
Obj1. Display()
